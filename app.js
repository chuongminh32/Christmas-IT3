...
$(document).ready(function () {
    ...
    let textTitle = "Gửi IT3❤️! ";
    let charArrTitle = textTitle.split("");
    let text =  "Chúc tập thể lớp IT3 một mùa Giáng Sinh thật an lành và tràn đầy niềm vui! Mong rằng mọi người sẽ đạt được nhiều thành công trong học tập và cùng nhau xây dựng những kỷ niệm đẹp. Chúc tất cả luôn khỏe mạnh, hạnh phúc, và luôn giữ vững ngọn lửa đam mê công nghệ. Merry Christmas IT3! 🎄✨";
